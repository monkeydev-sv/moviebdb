...
const Navbar = () => {
  ...
  return (
    <AppBar className={classes.appBar} position="static" color="inherit">
      ...
      <Typography component={Link} to="/" className={classes.heading} variant="h2" align="center"><img className={classes.image} src={MovieCoolector} alt="icon" height="60" /></Typography>
